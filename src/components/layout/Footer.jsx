        ...
        <footer className="p-6 md:p-8 bg-white">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 items-start text-center md:text-left">
                ...
                <div className="flex flex-col gap-4 md:mr-10">
                    ...
                    <p className="text-[#ED9B40] font-newzen font-medium text-md md:text-md leading-relaxed">
                ...
                <div>
                    <ul className="flex flex-col gap-6 md:gap-10 text-[#ED9B40] font-newzen font-bold align-baseline items-center text-xl md:text-xl">
                        <li>Services</li>
                        <li>Process</li>
                        <li>Portfolio</li>
                    </ul>
