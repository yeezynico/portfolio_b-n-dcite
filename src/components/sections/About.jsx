...
const About = () => {
  ...
  return (
    <div
      className="w-full h-[280px] min-[500px]:max-md:h-[420px] md:h-[613px] bg-cover bg-center relative overflow-visible mt-5 md:mt-20"
      style={{ backgroundImage: `url(${bgImage})` }}
    >
      <div
        className="w-full h-[280px] min-[500px]:max-md:h-[420px] md:h-[613px] bg-cover bg-center flex flex-col items-center justify-center max-md:justify-start gap-10 max-md:gap-4 relative"
      ...
      >
        ...
        <div className="flex items-center justify-center gap-8 text-[#ED9B40] font-newzen font-bold text-2xl min-[300px]:max-md:text-[12px] mr-96 -ml-4 max-md:flex-col max-md:items-start max-md:justify-start max-md:gap-2 max-md:text-base max-md:mr-0 max-md:ml-[3%] max-md:w-[48%] max-md:self-start max-md:mt-4">
      ...
      <img
        src={photo}
        alt="photo"
        className="absolute bottom-0 right-0 w-auto object-contain h-[280px] min-[500px]:max-md:h-[380px] md:h-auto"
      />
