    ...
    <div id="portfolio" className='bg-white'>
      <div className='bg-[#AA8F66] pt-10 w-full bg-cover bg-center mt-5 text-white'>
        ...
        <div className='grid grid-cols-3'>
          <img src={demisun} alt="demi soleil" className='relative top-1/3 -left-26 -translate-y-1/2 rotate-90 w-[60vh]'/>
        <div className="grid grid-cols-2 gap-6 px-6 relative z-10">
          {/* Bloc 1 */}
          <div className="grid grid-cols-2 gap-2">
            <img src={afronation} alt="Afro Nation" />
            <img src={mobileafronation} alt="Afro Nation App" />
            <img src={afronationbox} alt="Afro Nation Box" className="col-span-2" />
          </div>

          {/* Bloc 2 */}
          <div className="grid grid-cols-2 gap-2">
            <img src={ohbonpanier} alt="Oh Bon Panier" />
            <img src={legume} alt="Légume" />
            <img src={legumes} alt="Légumes" className="col-span-2" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <img src={kiabi} alt="Kiabi" className="col-span-2" />
          </div>

        </div>
          <img src={demisun} alt="demi soleil" className='relative -bottom-95 w-[60vh]'/>
...
{/* <div className="grid grid-cols-2">
  ...
  <div>
    <img src={mobileafronation} alt="Afro Nation App" className='ml-5'/>
  </div>
