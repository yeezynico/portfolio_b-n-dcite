...
const Process = () => {
  return (
    <div
      id="process"
      className="bg-[#ED9B40] pt-10 w-full bg-cover bg-center relative overflow-hidden"
    >
      <div className="mt-5 text-white max-w-7xl justify-center mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 ml-20 max-md:ml-0 gap-6 max-md:px-[10%]">
          {[
            {
              step: "1",
            ...
            >
              <div className="max-md:w-full max-md:flex max-md:flex-col max-md:items-center max-md:max-w-[180px] max-md:mx-auto">
                ...
                <h2 className="font-bold text-white text-lg md:text-xl max-md:text-left w-full">
                  {item.title}
                </h2>

                <p className="font-newzen font-medium text-white/90 text-md leading-6 mb-5 mt-3 md:w-[136px] max-md:w-full max-md:text-left">
                  {item.text}
                </p>
              </div>
            </div>
